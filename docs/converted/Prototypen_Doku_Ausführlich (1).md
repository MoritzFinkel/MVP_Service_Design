...
Mit diesem Lo-Fi Prototyp wollen wir folgende Fragestellungen klären:

1. **Verständlichkeit**: Können Nutzer:innen komplexe politische Entscheidungen durch vereinfachte Sprache und strukturierte Darstellung besser verstehen?
2. **Navigation & Informationsarchitektur**: Welche Ansicht bevorzugen Nutzer:innen – chronologische Timeline oder thematische Gruppierung? Wie intuitiv ist der Wechsel zwischen beiden?
3. **Informationstiefe**: Fühlen sich Nutzer:innen durch die gestaffelte Information (Übersicht → Zusammenfassung → Volltranskript) gut geleitet oder ist es zu verschachtelt?
4. **Feature-Relevanz**: Werden Such- und Filterfunktionen tatsächlich genutzt? Ist die Text-to-Speech Funktion ein echter Mehrwert oder Gimmick?
5. **Engagement**: Motiviert das Design dazu, mehrere Themen zu erkunden, oder wirkt es zu nüchtern/technisch?

## Umsetzung

**Form**: Funktionaler Klick-Dummy (interaktive Web-Anwendung)

**Warum diese Form?**

- Civic-Tech-Anwendungen leben von Interaktivität – statische Wireframes würden das Nutzererlebnis nicht ausreichend simulieren
- Filter-, Such- und Audio-Features müssen erlebbar sein, um sie zu bewerten
- Schnelles Iterieren möglich durch React-Komponenten
- Realistische Testumgebung für User Testing mit echten Geräten (Desktop & Mobile)
- Geringe Investition trotz hoher Interaktivität (keine Backend-Entwicklung nötig)

## Screens & Hauptansichten

### 1. **Timeline-Ansicht** (Haupteinstieg)

- Chronologische Darstellung aller Ratsentscheidungen
- Status-Indikator (genehmigt/ausstehend/abgelehnt)
- Klare Hierarchie: Titel → Datum → Zusammenfassung → Entscheidung

**Annahme**: Nutzer:innen wollen primär wissen "Was ist gerade passiert?" und orientieren sich chronologisch.

### 2. **Thematische Ansicht**

- Gruppierung nach Kategorien (Verkehr, Wohnen, Parks, etc.)
- Visuelle Differenzierung durch Icons und Farben
- Übersicht über Aktivität pro Themenbereich

**Annahme**: Engagierte Bürger:innen haben spezifische Interessenschwerpunkte und wollen gezielt navigieren.

### 3. **Such- & Filterleiste**

- Keyword-Suche über alle Inhalte (inkl. Transkripte)
- Datums-Filter für zeitliche Eingrenzung
- Kombinierbar mit Themen-Filter

**Annahme**: Power-User brauchen präzise Recherche-Tools für spezifische Themen oder Zeiträume.

### 4. **Detail-Ansicht**

- Dreiteilige Struktur:
- "Was das bedeutet" (Plain Language Summary)
- "Auswirkung auf die Community" (Impact)
- "Diskussions-Highlights" (Transkript-Auszüge)
- Call-to-Action: "Vollständiges Transkript ansehen"

**Annahme**: Abgestufte Information verhindert Overwhelm – Nutzer:innen entscheiden selbst, wie tief sie einsteigen.

### 5. **Volltranskript mit TTS**

- Umschaltung zwischen Lese- und Hör-Modus
- Audio-Controls (Play/Pause/Restart)
- Visuelles Highlighting des aktuell vorgelesenen Abschnitts

**Annahme**: Barrierefreiheit und alternative Nutzungsformate (z.B. "Podcast-Modus" beim Pendeln) erhöhen Reichweite.

## Funktionsweise & Annahmen-Überprüfung

### Kern-Interaktion:

1. **Einstieg**: Nutzer:in landet auf Timeline → sieht sofort neueste Entscheidungen
2. **Exploration**: Klick auf Karte → Detail-Ansicht mit vereinfachter Erklärung
3. **Vertiefung**: Optional Transkript lesen oder anhören
4. **Alternative**: Über Themen-Filter oder Suche gezielt navigieren

### Zu validierende Annahmen:

- ✅ Spacious Design reduziert kognitive Last bei komplexen Themen
- ✅ "Plain Language"-Ansatz macht politische Inhalte zugänglicher
- ❓ TTS-Feature wird aktiv genutzt (oder nur "nice to have"?)
- ❓ Nutzer:innen erkunden mehrere Themen pro Session (oder nur ein spezifisches?)
- ❓ Balance zwischen Information und Übersichtlichkeit ist getroffen

## Lernfokus für nächste Iteration

**Vor Hi-Fi Prototyping müssen wir herausfinden:**

1. **Content-Struktur**:
- Ist die Dreiteilung (Summary/Impact/Highlights) die richtige Granularität?
- Fehlen wichtige Informationen (z.B. Abstimmungsergebnis, beteiligte Personen)?
1. **Feature-Priorisierung**:
- Welche Features werden ignoriert? (→ entfernen oder prominenter machen)
- Welche fehlen? (z.B. Benachrichtigungen, Kommentare, Teilen-Funktion)
1. **Visuelle Hierarchie**:
- Lenkt das Design die Aufmerksamkeit auf die wichtigsten Infos?
- Ist der "Spacious"-Ansatz zu minimalistisch oder genau richtig?
1. **Nutzungskontext**:
- Wird mobil oder Desktop genutzt?
- Kurze Sessions (schnell informieren) oder lange (recherchieren)?
1. **Accessibility**:
- Funktioniert TTS in allen Browsern zuverlässig?
- Ist Kontrast/Schriftgröße für alle Altersgruppen geeignet?
1. **Content-Strategie**:
- Wie viel "Plain Language"-Vereinfachung ist nötig, ohne zu vereinfachen?
- Muss die Original-Formulierung sichtbarer sein?

# Prototyp Link

[https://ranch-crush-31990840.figma.site/](https://ranch-crush-31990840.figma.site/)
...
| **Schnelle Iterationen** | Code-basiert ermöglicht schnelle präzise Anpassungen nach Feedback |
...
### 8.2 Limitierungen des Lo-Fi Prototyps
...
[https://github.com/MoritzFinkel/MVP_Service_Design](https://github.com/MoritzFinkel/MVP_Service_Design)